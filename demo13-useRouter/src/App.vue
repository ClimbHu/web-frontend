...
<template>
  <div>
    ...
    <!-- v-bind:to会被转换成上述路径 -->
    <router-link v-bind:to="{path:'/showDetail2',query:{id:3,language:'C++'}}">声明式路由键值对传参</router-link>
    <button @click="showDetail2(4, 'Python')">编程式路由键值对传参</button>
    <br />
